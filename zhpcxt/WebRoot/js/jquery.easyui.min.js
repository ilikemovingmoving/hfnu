...
function _1de(_1df,_1e0,_1e1,_1e11){
var clo = _1e11 == undefined?true:_1e11;
...
win.window({title:_1df,width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,closable:clo,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
win.window("open");
},alert:function(_1e4,msg,icon,fn,_1e44){
...
var win=_1de(_1e4,_1e5,_1e6,_1e44);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"This field is required.",invalidMessage:null,rules:{pattern:{validator:function(_2faa){
return /^[a-zA-Z0-9]+$/i.test(_2faa);
},message:"Please enter number and letter assemble."},repeat:{validator:function(_2fab,_2fac){
	if(_2fab != $(_2fac).val()){
		return false;
	}else{
		return true;
	}
},message:"twice enter value twice."},email:{validator:function(_2fa){
